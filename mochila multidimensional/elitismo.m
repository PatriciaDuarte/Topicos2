...
function [melhores] = elitismo(nvPopulacao, populacao)
    ...
    [nvMenor, fitNvPopulacao] = melhorResultado(nvPopulacao);
    [menor, fitPopulacao] = melhorResultado(populacao);

    % uni e ordena todos os elementos em um unico vetor
    [fitGeral, fitGeralIndex] = sort([fitNvPopulacao fitPopulacao], "descend");
